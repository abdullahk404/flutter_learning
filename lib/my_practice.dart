...
class DartBasics {
  ...
  print( "Printing the Name " "$name");*/
    ...
    print(nums);
    print(nums.remove(6)); // Remove the value 6
    print(nums.removeAt(0)); // Remove whatever is at index 0
    print(nums.clear); // Removes everything
    print(nums.reversed);
    print(nums.length);
    print(nums.reversed);
    print(nums.isEmpty);
    ...
    //************ Sets
    // sets are like a list but they contain the unique elements
    var asiaCountries = <String>{"Pakistan", "Afghanistan", "Iran"};

    var northCountries = <String>{"NorhtAmarica", "NortKoria", "Iran"};

    var soutAsians = <String>{
      "Pakistan",
      "Afghanistan",
      "Uzbekistan",
      "Kirghistan",
    ...
    print(
      "Union of the Sets ${asiaCountries.union(northCountries).union(soutAsians)}",
    );

    print(
      "Intersection of the Sets ${asiaCountries.intersection(northCountries).intersection(soutAsians)}",
    );

    print(
      "Difference of the Sets ${asiaCountries.difference(northCountries).difference(soutAsians)}",
    );
    ...
    if (a < b) {
      ...
      print("a is less then be");
    }
    //*************** Switch statement
    print("Enter your Ranking no");
    int? ranking=stdin.readByteSync();
    switch (ranking) {
      case 5:
        {
          print("Rank 5 is good level Ranking ");
        }
        break;
      case 10:
        {
          print("Rank 10 is excellent");
        }
        break;
      default:
        {
          print("Ranking up to 10 is extreme level ");
        }
    }
